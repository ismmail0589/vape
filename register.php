...
if (isset($_POST["f_name"])) {
    ...
    if (
        empty($f_name) || empty($l_name) || empty($email) || empty($password) ||
        ...
        if (!(strlen($mobile) == 11)) {
            echo "
                <div class='alert alert-warning'>
                    <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
                    <b>The mobile number must be 11 digits</b>
                </div>
            ";
            exit();
        }
        ...
        if ($count_email > 0) {
            echo "
                <div class='alert alert-danger'>
                    <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
                    <b>Email Address is already taken. Please use another email address</b>
                </div>
            ";
            exit();
        } else {
            ...
            if ($run_query) {
                ...
                echo "
                    <div class='alert alert-danger'>
                        <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
                        <b>Registration failed. Please try again later.</b>
                    </div>
                ";
            }
        }
